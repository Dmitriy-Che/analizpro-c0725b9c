            ...
            >
              <div className="w-full h-full rounded-[22px] bg-card/90 backdrop-blur p-8 flex flex-col items-center justify-center text-center">
                ...
                <div className="flex items-center justify-center gap-2 mb-3" aria-label="Поддерживаемые языки">
                  <CircleFlag countryCode="gb" inline className="w-6 h-6 max-w-[50px] max-h-[50px]" title="Английский" />
                  <CircleFlag countryCode="vn" inline className="w-6 h-6 max-w-[50px] max-h-[50px]" title="Вьетнамский" />
                  <CircleFlag countryCode="th" inline className="w-6 h-6 max-w-[50px] max-h-[50px]" title="Тайский" />
                  <CircleFlag countryCode="ru" inline className="w-6 h-6 max-w-[50px] max-h-[50px]" title="Русский" />
                </div>
