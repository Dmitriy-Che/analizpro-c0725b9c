    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-accent/5 pt-16 lg:pt-0 pb-6 lg:pb-12">
      ...
      <div className="relative max-w-[480px] lg:max-w-6xl mx-auto px-4 lg:px-8 py-6 lg:py-12">
        ...
        <p className="text-xs text-muted-foreground text-center mt-8 max-w-xl mx-auto">
          Оплата выполняется в долларах США (USD / USDT) по QR-коду или по адресу кошелька. Для альтернативной оплаты пишите в поддержку. После подтверждения платежа расшифровки активируются автоматически и мы пришлём уведомление. Отчёты хранятся 30 дней.
        </p>
