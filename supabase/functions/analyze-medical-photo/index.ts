...
[Для КАЖДОГО показателя с отклонением создай ОТДЕЛЬНЫЙ блок в таком формате:]

[Понятное название показателя (расшифровка аббревиатуры)]: [значение]
Референсный диапазон для ${gender === 'male' ? 'мужчин' : 'женщин'} ${age} лет: [диапазон]

💡 Что это может означать:
[Конкретное, спокойное объяснение именно для ЭТОГО показателя: что он измеряет, почему может быть такое значение, насколько это распространено. Упомяни, что это не обязательно означает заболевание и важно обсудить с врачом]

🔍 Рекомендации для этого показателя:
- Стоит показать результаты врачу [конкретный специалист для этого показателя] для полной оценки
- [Какие дополнительные исследования могут понадобиться конкретно для этого показателя]
- [Какие факторы образа жизни могут влиять на этот конкретный показатель]

━━━━━━━━━━━━━━━━━━━━

[Следующий показатель в том же формате, если есть...]

[Продолжай для всех показателей с отклонениями]
